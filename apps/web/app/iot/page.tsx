...
export default function Page() {
  return <><Header/><main className="pc-shell min-h-[760px] px-5 py-16"><div className="mx-auto max-w-7xl">
    ...
    <h1 className="mt-3 max-w-4xl text-5xl font-semibold tracking-tight">IoT Operations</h1>
    <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-500">Connect, monitor, and automate renewable infrastructure devices.</p>
