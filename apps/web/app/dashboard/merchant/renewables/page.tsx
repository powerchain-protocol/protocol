...
export default function Page(){return <section><p className="text-sm font-medium text-emerald-300">Merchant energy commerce</p><h1 className="mt-2 text-3xl font-semibold">Renewable real-world assets</h1><p className="mt-2 max-w-3xl text-slate-400">Verified solar, wind, battery, hydrogen and distributed-generation assets ready for tokenized commerce.</p><div className="mt-7"><RwaMarket assets={[...rwaAssets]} initialFilter="renewable"/></div><Link href="/dashboard/merchant" className="mt-8 inline-block text-sm text-emerald-300">← Merchant dashboard</Link></section>}
