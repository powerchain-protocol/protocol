    ...
    <>
      ...
      <main className="pc-shell min-h-[760px] px-5 py-14">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="mt-3 text-5xl font-semibold">Energy operations</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-500">Monitor production, consumption, storage, local markets, and grid performance.</p>
